...
#AutoIt3Wrapper_Res_Description=Easily create a GenOS Live USB
#AutoIt3Wrapper_Res_Fileversion=1.0.0.0
#AutoIt3Wrapper_Res_FileVersion_AutoIncrement=Y
#AutoIt3Wrapper_Res_SaveSource=y
#AutoIt3Wrapper_Res_Field=Site|http://www.gen-os.info
...
; Author           : Thibaut Lauzière (Slÿm) and GenOS team
; Author's Website : www.slym.fr and www.gen-os.info
; License          : GPL v3.0
...
; Global constants
Global Const $software_version = "9.9"
...
Global Const $check_updates_url = ""
...
; Step 2 Graphics
Global $DRAW_CHECK_STEP2, $DRAW_ISO, $DRAW_BACK, $DRAW_BACK_HOVER, $HELP_STEP2, $label_iso, $label_cd, $label_download, $label_step2_status, $download_label2, $OR_label, $ISO_AREA, $CD_AREA, $DOWNLOAD_AREA, $BACK_AREA
...
; Step 2 images
Global $ISO_PNG, $ISO_HOVER_PNG, $BACK_PNG, $BACK_HOVER_PNG
...
$splash_status = GUICtrlCreateLabel("   " & Translate("Starting GenOS USB Creator") & " " & $full_version, 2, 109, 344, 19)
...
$GUI = GUICreate("GenOS USB Creator", 450, 750, -1, -1, $WS_POPUP, $WS_EX_LAYERED)
GUISetFont($font_size)
...
$CONTROL_GUI = GUICreate("GenOS USB Creator", 450, 750, 5, 7, $WS_POPUP, BitOR($WS_EX_LAYERED, $WS_EX_MDICHILD), $GUI)
GUISetFont($font_size)
...
$label_iso = GUICtrlCreateLabel("ISO", 40 + $offsetx0, 302 + $offsety0, 110, 50)
GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
GUICtrlSetColor(-1, 0xFFFFFF)
...
Func MoveGUI($hW)
	...
	ControlFocus("GenOS USB Creator", "", $REFRESH_AREA)
EndFunc   ;==>MoveGUI
...
Func Control_Hover()
	...
	Local $CursorCtrl
	If WinActive("GenOS USB Creator") Or WinActive("GenOS USB Creator") Then
